...
namespace BNG {
    ...
    public class InputBridge : MonoBehaviour {
        ...
        void Start() {
            ...
            if(CheckFixedDeltaTime && Time.fixedDeltaTime == 0.02f) {
                Debug.LogWarning("Time.fixedDeltaTime is set to Unity's default of 0.02, which can cause jittery movement in VR. Setting to device refresh rate instead. You can disable this by adjusting your Fixed Timestep manually in your project or via script.");
                ...
                if(refreshRate != 0) {
                    ...
                    // Default to 72fp : 1/72 =  0.0133338
